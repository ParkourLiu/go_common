...
func (c *SftpClient) Open(srcPath string) (*sftp.File, error) {
	return c.sftpClient.Open(srcPath) //远程
}
...
// 获取信息
func (c *SftpClient) GetFileInfo(path string) (os.FileInfo, error) {
